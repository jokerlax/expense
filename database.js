...
const DEFAULT_SEEDS = {
  ...
  expenses: [
    {
      ...
      description: "Flight ticket for Jakarta Client Onboarding",
      receiptUrl: "receipt_flight.jpg",
    ...
    },
    {
      ...
      currency: "IDR",
      paymentMethod: "Cash",
      description: "Airport Limousine & Local Taxi Transfers",
    ...
    },
    {
      ...
      receiptUrl: "receipt_hotel.jpg",
      status: "PENDING_FINANCE",
      reportId: "RPT002",
      remarks: "Approved by manager Sarah",
    ...
    },
    {
      ...
      description: "Bulk Site Office Supplies",
      receiptUrl: "receipt_stationery.png",
      status: "PENDING_FINANCE",
      reportId: "RPT002",
      remarks: "Approved by manager Sarah",
  ...
  reports: [
    {
      id: "RPT001",
      title: "Q3 Business Travel & Client Onboarding",
      startDate: "2026-08-20",
      endDate: "2026-08-22",
      approver: "Sarah",
      verifier: "Finance User",
      employeeId: "EMP001",
      employeeName: "John",
      status: "PENDING_MANAGER",
    ...
    {
      id: "RPT002",
      title: "Jakarta Site Inspection & Supplies",
    ...
    {
      id: "RPT003",
      title: "Draft Client Dinner & Catering",
  ...
  reasons: [
    ...
    { code: "INVD", name: "Invalid Date", type: "Clarification" },
    { code: "EXCL", name: "Exceeds Category Limit", type: "Clarification" },
    { code: "DUPC", name: "Duplicate Claim", type: "Rejection" },
    { code: "UNPL", name: "Unapproved Policy Violation", type: "Rejection" },
    { code: "OTHR", name: "Other Reason", type: "Both" }
  ],
  expenseStatuses: [
    { code: "DRAFT", label: "Draft" },
    { code: "UNREPORTED", label: "Unreported Pool" },
    { code: "PENDING_MANAGER", label: "Pending Manager Approval" },
    { code: "PENDING_FINANCE", label: "Pending Finance Verification" },
    { code: "FINANCE_APPROVED", label: "Finance Verified" },
    { code: "PAID", label: "Paid / Reimbursed" },
    { code: "MANAGER_REJECTED", label: "Rejected by Manager" },
    { code: "FINANCE_REJECTED", label: "Rejected by Finance" },
...
class LocalDatabase {
  ...
  init() {
    const versionKey = "EXPENSE_ERP_V5_SEED_RESET_MODERN";
